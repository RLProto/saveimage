...
# Configuration and Constantsa
OPC_SERVER_URL = os.getenv('OPC_SERVER_URL', 'opc.tcp://localhost:53880/UA/VisionOPC')
TAG_NAME = os.getenv('TAG_NAME', 'ns=1;s=passo')
PRODUCT_TAG_NAME = os.getenv('PRODUCT_TAG_NAME', 'ns=1;s=valorPrevisto')
